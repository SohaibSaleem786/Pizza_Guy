...
const UserId =33;
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('tableName', values.tableNamee);
      formData.append('status', value.statuss);


      axios
        .post(
          `${apiLinks}/AddTable.php`,
          formData,
          {
...
<PathHead pageName="File > Table Maintenance > Add Table" screen='Get_Item' pageLink="/Get_Table"/>
