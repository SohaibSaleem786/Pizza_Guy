...
<div style={{
      ...
      <PathHead pageName="Transaction > Check Out Orders > Order List" screen='Get_Item' pageLink="/MainPage"/>

      <div className="col-12" style={{ color: secondaryColor }}>
        

        <br />
        <div style={{ marginLeft: "15%", marginRight: "15%", maxWidth: "70%" , padding:'10px',backgroundColor:'white',border:'1px solid black', }}>
