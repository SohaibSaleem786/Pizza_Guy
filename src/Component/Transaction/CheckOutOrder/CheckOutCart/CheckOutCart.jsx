...
// You can also call fetchItemData elsewhere in your component as needed
  ...
  return (
    ...
    <div 
      ...
      <Header id={id} />
      <PathHead pageName="Transaction > Check Out Orders > Order List > Cart Item" screen='Get_Item' pageLink="/Check_Out_List"/>



    <div >
    <div style={{marginLeft:'11%',marginRight:'12%',marginTop:'3%',backgroundColor:'white',border:'1px solid black',padding:'10px'  }}>
    <Row>
            ...
            <div style={{ maxHeight: "65vh", overflowY: "scroll" }} >
              ...
              >
                ...
                {tableData.rows.map((item, index) => {
                  ...
                  {Array.from({ length: Math.max(0, 11 - tableData.rows.length) }).map((_, index) => (
    <tr key={`blank-${index}`}>
