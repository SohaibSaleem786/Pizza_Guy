...
//       const response = await axios.post(`${apiLinks}/CheckOut.php`, formData, {
...
//         {/* <PathHead
//           pageName="Transaction > Order > Category > Order Number > Cart Item > Checkout"
//           screen="Get_Item"
//           pageLink="/Order_Number"
//         /> */}
// <PathHead
//           pageName="Transaction > Order Dashboard > Checkout"
//           screen="Get_Item"
//           pageLink="/Order_Dashboard"
//         />
...
//                               >
//                                 {data.map((item) => (
//                                   <option key={item.dvid} value={item.dvid}>
//                                     {item.dvdsc}
//                                   </option>
//                                 ))}
//                               </select>{" "}
...
//                       <div
//                         className={`cards ${
//                           detailItem.length > 0 ? "cards-large" : "cards-small"
//                         }`}
//                         style={{
//                           textAlign: "left",
//                           maxHeight: "250px",
...
//                           const filteredItemPictures = itemPictures
//                             ? itemPictures.filter(
//                                 (apiItem) => apiItem.TItmId === row.titmid
//                               )
//                             : [];
...
import { useTheme } from "../../../../../../../ThemeContext";
import { useLocation } from "react-router-dom";
import { MDBTable, MDBTableHead, MDBTableBody ,MDBTableFoot} from "mdbreact"; // Import the necessary components from "mdbreact"
import {
  Card,
  Row,
  Col,
             ...
             return (
               <tr key={index}>
                 ...
                 <td style={{ textAlign: "left" }}>{item.titmdsc}</td>
                       ...
                       <td >{item.titmqnt}</td>
                       <td style={{ textAlign: "right" }}>{item.salamt}</td>
...
{Array.from({ length: Math.max(0, 12 - detailItem.length) }).map((_, index) => (
       <tr key={`blank-${index}`}>
